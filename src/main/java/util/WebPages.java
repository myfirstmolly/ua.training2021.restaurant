...
public class WebPages {
    ...
    public static final String ADD_DISH_COMMAND = "/api?command=addDish";
    ...
    public static final String ADD_DISH_PAGE = "/jsp/add-dish.jsp";

    public static final String DEFAULT_PAGE = "/api?command=menu";
}
